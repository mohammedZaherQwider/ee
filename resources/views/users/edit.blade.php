            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label>االسجل المدني</label>
                            {!! Form::text('civil_registry', null, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                ...
                <div class="row mg-b-20">
                    <div class="col-xs-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select name="section_id" id="select-section"
                                class="form-control  nice-select  custom-select">
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}"{{ $section == $sectionID ? 'selected' : '' }}>
                                        {{ $section->name }}
                                    </option>
                                    >{{ $section->name }}</option>
                                @endforeach
